...
const promptText = `
เขียนบทความภาษาไทยขึ้นมาใหม่ให้ไม่เหมือนบทความใดๆแบบสุ่ม ความยาวประมาณ 428 คำ โดยบทความจะต้องเกี่ยกวข้องกับการโปรโมทการรักษาสิวด้วย "Accure laser" ที่ "เอ็มวีต้าคลินิก" (คลินิกรักษาสิว)
ต้องมี Keywords ต่อไปนี้ปะปนแบบสุ่มอยู่ในบทความให้ครบทุกคำ: คลินิกรักษาสิว, รักษาสิว, เลเซอร์สิว, หลุมสิว, รอยสิว, สิว, รอยดำรอยแดง, Accure laser
...
ชื่อหัวข้อบทความต้องใหม่ล่าสุด ดึงดูด ไม่ซ้ำ และ ใช้หลัก Semantic SEO ในการตั้งชื่อ ส่วนเนื้อหาต้องใหม่ ไม่ซ้ำ อ่านแล้วเป็นธรรมชาติ น่าสนใจ และ จัดรูปแบบเป็น HTML paragraph tags (<p>...</p>) ให้พร้อมใช้งาน (ไม่ต้องใส่ <html> หรือ <head> มาให้ เอาเฉพาะส่วนเนื้อหา <p>, <h2>)
`;
